    ...
    <div className="bg-black text-white py-16 md:py-24 px-4">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className={`relative h-full bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm border ${
                ...
                <div className="flex items-center gap-2 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  ...
                  <ChevronRight className={`w-4 h-4 bg-gradient-to-r ${service.color} bg-clip-text text-transparent`} />
                </div>
        ...
        <div className="flex justify-center md:hidden mt-8">
          <button className="group flex items-center gap-2 px-8 py-3 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105">
            View All Services
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className={`w-14 h-14 ${services[activeService].bgColor} rounded-xl flex items-center justify-center`}>
                    <div className={`bg-gradient-to-br ${services[activeService].color} bg-clip-text text-transparent`}>
